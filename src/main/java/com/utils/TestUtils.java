...
public class TestUtils {
	...
	public HashMap<String,String> parseStringXML(FileInputStream fis) throws Exception{
		...
		for(int temp=0;temp<nList.getLength();temp++) {
			...
			if(node.getNodeType()==Node.ELEMENT_NODE) {
				...
				stringMap.put(nElement.getAttribute("name"), nElement.getTextContent());
			}
